...
CANDIDATOS = [
    ("psicologia-financeira", "A Psicologia Financeira", "Morgan Housel", "6555111100",
    ...
    ("hora-da-estrela", "A Hora da Estrela", "Clarice Lispector", "853250812X",
    ...
    ("habitos-atomicos", "Hábitos Atômicos", "James Clear", "8550807567",
    ...
    ("homem-mais-rico-babilonia", "O Homem Mais Rico da Babilônia", "George S. Clason", "8595081530",
    ...
    ("noites-brancas", "Noites Brancas", "Fiódor Dostoiévski", "8582850743",
    ...
    ("quatro-compromissos", "Os Quatro Compromissos", "Don Miguel Ruiz", "6557120956",
    ...
    ("mais-esperto-que-o-diabo", "Mais Esperto que o Diabo", "Napoleon Hill", "8568014003",
    ...
    ("quebrando-o-habito", "Quebrando o Hábito de Ser Você Mesmo", "Joe Dispenza", "8568014321",
    ...
    ("como-fazer-amigos", "Como Fazer Amigos e Influenciar Pessoas", "Dale Carnegie", "8504018024",
    ...
    ("essencialismo", "Essencialismo", "Greg McKeown", "8543102146",
    ...
    ("sutil-arte", "A Sutil Arte de Ligar o F*da-se", "Mark Manson", "855100249X",
    ...
    ("mulheres-que-correm-com-os-lobos", "Mulheres que Correm com os Lobos", "Clarissa Pinkola Estés", "853252978X",
    ...
    ("sociedade-do-cansaco", "Sociedade do Cansaço", "Byung-Chul Han", "8532649963",
    ...
    ("assim-falou-zaratustra", "Assim Falou Zaratustra", "Friedrich Nietzsche", "8535930485",
    ...
    ("mundo-de-sofia", "O Mundo de Sofia", "Jostein Gaarder", "8535921893",
    ...
    ("crime-e-castigo", "Crime e Castigo", "Fiódor Dostoiévski", "8573262087",
    ...
    ("irmaos-karamazov", "Os Irmãos Karamázov", "Fiódor Dostoiévski", "8573265388",
    ...
    ("o-idiota", "O Idiota", "Fiódor Dostoiévski", "8573262559",
     ...
     ["Literatura", "Psicologia", "Rússia"]),
    ("memorias-do-subsolo", "Memórias do Subsolo", "Fiódor Dostoiévski", "8573261854",
    ...
    ("o-principe", "O Príncipe", "Nicolau Maquiavel", "8563560034",
    ...
    ("48-leis-do-poder", "As 48 Leis do Poder", "Robert Greene", "8532521665",
    ...
    ("leis-da-natureza-humana", "As Leis da Natureza Humana", "Robert Greene", "6555353686",
    ...
    ("arte-da-seducao", "A Arte da Sedução", "Robert Greene", "6555322047",
    ...
    ("rapido-e-devagar", "Rápido e Devagar: Duas Formas de Pensar", "Daniel Kahneman", "853900383X",
    ...
    ("jogos-da-vida", "Os Jogos da Vida", "Eric Berne", "8521308760",
    ...
    ("comunicacao-nao-violenta", "Comunicação Não-Violenta", "Marshall B. Rosenberg", "8571838267",
    ...
    ("coragem-de-nao-agradar", "A Coragem de Não Agradar", "Ichiro Kishimi & Fumitake Koga", "8543105692",
    ...
    ("armas-da-persuasao", "As Armas da Persuasão", "Robert B. Cialdini", "8575428098",
    ...
    ("nunca-divida-a-diferenca", "Nunca Divida a Diferença", "Chris Voss", "8543108055",
    ...
    ("conversas-cruciais", "Conversas Cruciais", "Kerry Patterson e outros", "8593585000",
    ...
    ("escute", "Escute!", "Kate Murphy", "6555646292",
    ...
    ("obrigado-pelo-feedback", "Obrigado pelo Feedback", "Douglas Stone & Sheila Heen", "8582850263",
    ...
    ("poder-dos-quietos", "O Poder dos Quietos", "Susan Cain", "8595080747",
    ...
    ("pai-rico-pai-pobre", "Pai Rico, Pai Pobre", "Robert T. Kiyosaki", "8550801488",
    ...
    ("segredos-da-mente-milionaria", "Os Segredos da Mente Milionária", "T. Harv Eker", "8575425927",
    ...
    ("investidor-inteligente", "O Investidor Inteligente", "Benjamin Graham", "8595080801",
    ...
    ("do-mil-ao-milhao", "Do Mil ao Milhão", "Thiago Nigro", "8595083274",
    ...
    ("quem-pensa-enriquece", "Quem Pensa, Enriquece", "Napoleon Hill", "6587885004",
    ...
    ("psicopolitica", "Psicopolítica", "Byung-Chul Han", "8592649390",
    ...
    ("realismo-capitalista", "Realismo Capitalista", "Mark Fisher", "6587233090",
    ...
    ("geracao-ansiosa", "A Geração Ansiosa", "Jonathan Haidt", "8535938532",
    ...
    ("1984", "1984", "George Orwell", "8535914846",
    ...
    ("admiravel-mundo-novo", "Admirável Mundo Novo", "Aldous Huxley", "8525056006",
    ...
    ("21-licoes", "21 Lições para o Século 21", "Yuval Noah Harari", "8535930914",
    ...
    ("amor-liquido", "Amor Líquido", "Zygmunt Bauman", "8571107955",
    ...
    ("sete-saberes", "Os Sete Saberes Necessários à Educação do Futuro", "Edgar Morin", "8524917547",
    ...
    ("cabeca-bem-feita", "A Cabeça Bem-Feita", "Edgar Morin", "852860764X",
     ...
     ["Educação", "Filosofia", "Complexidade"]),
    ("pensamento-complexo", "Introdução ao Pensamento Complexo", "Edgar Morin", "8520505988",
    ...
    ("coisa-de-rico", "Coisa de Rico", "Michel Alcoforado", "6556928585",
    ...
    ("insustentavel-leveza-do-ser", "A Insustentável Leveza do Ser", "Milan Kundera", "8535912517",
