...
CHAPTERS = [
 {"slug":"ch01-nao-me-faca-pensar","sub":"CAPÍTULO 1: Não Me Faça Pensar (a 1ª Lei)",
  ...
  "cards":[
      {"ic":"target","t":"A Regra Zero da Web","emph":"Regra Zero","b":"A interface implora: não adicione carga cognitiva onde não existe necessidade. O usuário não clica num link para resolver um enigma ou decifrar metáforas brilhantes. Se ele precisar parar e calcular onde deve clicar para ver o preço, <strong>a sua genialidade falhou como design</strong>. A intuição não é beleza, é ausência de atrito.","tip":"<strong>Modelo mental:</strong> cada segundo gasto entendendo como a navegação funciona é um segundo a menos desejando o que você vende."},
      {"ic":"eye","t":"O Olhar Desatento","emph":"Desatento","b":"O designer projeta como se a tela fosse uma obra de arte que seria admirada; o usuário a trata como um outdoor lido a 100km/h na estrada. As pessoas não leem tutoriais e não desbravam menus inteiros: elas <strong>passam os olhos e clicam no primeiro botão que vagamente se parece</strong> com a solução do problema.","tip":"<strong>Prática:</strong> formate o texto para o escaneamento cego — use fontes grotescas, negritos gigantes e pule a prosa poética."},
      {"ic":"gap","t":"O Risco da Metáfora","emph":"Metáfora","b":"Chamar o carrinho de compras de “Bolsa de Magias” e a página de contato de “Sinal de Fumaça” soa poético na reunião criativa, mas cega o visitante. A familiaridade na web salva o tempo de todo mundo. Quando você arranca as convenções sólidas em nome de uma originalidade superficial, <strong>você cobra pedágio no lugar errado</strong>.","tip":"<strong>Armadilha:</strong> inventar a roda nas interfaces destrói a convenção; o usuário sempre prefere a previsibilidade chata ao labirinto exótico.","warn":True},
    ],
 ...
 {"slug":"ch03-design-escaneabilidade","sub":"CAPÍTULO 3: Design para Escaneabilidade (Billboard 101)",
  ...
  "cards":[
      {"ic":"layers","t":"Os 5 Movimentos do Billboard 101","emph":"Billboard 101","b":"Desenhe a página como um outdoor: <strong>1) aproveite convenções</strong> (logo no topo-esquerda, carrinho à direita); <strong>2) crie hierarquia visual</strong> (importante = proeminente, relacionado = agrupado); <strong>3) divida em áreas claras</strong>; <strong>4) deixe óbvio o que é clicável</strong>; <strong>5) elimine o ruído</strong>.","tip":"<strong>Como aplicar:</strong> faça a aparência refletir a estrutura — o olho deve 'ler' a organização antes de ler as palavras.","wide":True},
      {"ic":"book","t":"Convenções > Inovação","emph":"Convenções","b":"Padrões consagrados são processados <strong>sem esforço</strong> porque já foram aprendidos em mil outros sites. Inove apenas quando tiver certeza de que a nova forma é claramente melhor e tão óbvia quanto a convenção.","tip":"<strong>Modelo mental:</strong> convenções são vocabulário compartilhado — economizam o 'pensar' do usuário."},
      {"ic":"spark","t":"Eliminar o Ruído (Noise)","emph":"Ruído","b":"Banners, animações e cores que competem entre si <strong>afogam o conteúdo</strong>. Há três tipos de ruído: barulho de fundo, bagunça e tagarelice visual. Cada elemento extra rouba atenção do que importa.","tip":"<strong>Cuidado:</strong> hierarquia plana (tudo do mesmo tamanho/peso) deixa o usuário sem saber por onde começar.","warn":True},
    ],
 ...
 {"slug":"ch04-omita-palavras","sub":"CAPÍTULO 4: Omita as Palavras Desnecessárias",
  ...
  "cards":[
      {"ic":"steps","t":"A 3ª Lei: Corte pela Metade, Duas Vezes","emph":"Corte pela Metade","b":"Adaptando Strunk & White à web: <strong>'livre-se de metade das palavras de cada página, depois livre-se de metade do que sobrou'</strong>. A maioria das páginas suporta esse corte sem perda de informação — só de ruído.","tip":"<strong>Como aplicar:</strong> seja um editor implacável; cada palavra deve justificar a própria presença ou sair.","wide":True},
      {"ic":"bubble","t":"Mate o Happy Talk","emph":"Happy Talk","b":"O <strong>'blá-blá feliz'</strong> de boas-vindas e auto-promoção ('Bem-vindo ao nosso site! É um prazer recebê-lo...') não diz nada útil e ocupa o espaço nobre. É ruído puro: corte por inteiro.","tip":"<strong>Regra:</strong> se o texto não ajuda o usuário a agir, ele é candidato a corte."},
      {"ic":"gap","t":"Instruções São um Sintoma","emph":"Sintoma","b":"A maioria das instruções é <strong>ignorada</strong>. Em vez de explicar, torne as coisas tão óbvias que dispensem instrução; o que sobrar, reduza ao mínimo essencial, junto do ponto de uso.","tip":"<strong>Cuidado:</strong> precisar de instrução longa costuma significar que o design não está óbvio o bastante.","warn":True},
    ],
