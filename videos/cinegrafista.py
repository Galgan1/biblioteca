...
def tratamento(modo, tem_imagem, motion_pago, depthflow_ok):
    """PURO: escolhe o tratamento de movimento da cena.
      'motion'    — clipe de movimento pago já produzido (Veo/Kling)
      'parallax'  — DepthFlow 2.5D grátis (lane NORMAL, com imagem)
