    ...
    res = (
        ...
        .insert(
            ...
            body={
                'snippet': {
                    'title': title,
                    'description': 'Resumos cinematográficos de livros — canal Minuto Real.',
...
def post_publish(yt, cfg, video_id):
    ...
    if tm:
        ...
        print(
            "  [aviso] sem _stems/<slug>/timing.json -> legendas/capitulos pulados (use um build atual)"
        )
    try:
