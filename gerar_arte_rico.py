...
ICONS = {
    ...
    'checklist': svg(
        ...
        P('M14 32H50'),
        P('M14 48H50'),
        P('M6 14L9 17L13 12', 2.5),
        P('M6 30L9 33L13 28', 2.5),
        P('M6 46L9 49L13 44', 2.5),
    ),
    'mask': svg(
    ...
    'coins': svg(
        C(24, 24, 12),
        P('M24 18V30'),
        P('M20 21H27C28.7 21 30 22.3 30 24C30 25.7 28.7 27 27 27H20'),
        C(40, 42, 12),
        P('M40 36V48'),
        P('M36 39H43C44.7 39 46 40.3 46 42C46 43.7 44.7 45 43 45H36'),
    ),
    'cascade': svg(
        P('M10 14H26V26'),
        P('M26 26H42V38'),
        P('M42 38H54V50'),
        P('M22 22L26 26L30 22', 2.5),
        P('M38 34L42 38L46 34', 2.5),
    ),
    'trophy': svg(
        P('M20 12H44V26C44 33 38 38 32 38C26 38 20 33 20 26V12Z'),
        P('M20 16H12V20C12 25 16 28 20 28'),
        P('M44 16H52V20C52 25 48 28 44 28'),
        P('M32 38V48'),
        P('M22 52H42'),
        P('M26 52C26 49 28 48 32 48C36 48 38 49 38 52'),
    ),
    'hierarchy': svg(
    ...
    'shield': svg(
        P('M32 10L52 18V32C52 44 43 52 32 56C21 52 12 44 12 32V18L32 10Z'),
        P('M24 32L30 38L42 26', 2.5),
    ),
    ...
    'water': svg(
        P('M8 26C14 20 18 20 24 26C30 32 34 32 40 26C46 20 50 20 56 26'),
        P('M8 40C14 34 18 34 24 40C30 46 34 46 40 40C46 34 50 34 56 40'),
    ),
    'focus': svg(
        C(32, 32, 8),
        P('M32 8V18'),
    ...
    'wind': svg(
        P('M8 24H38C42 24 46 21 46 16C46 11 42 10 39 13'),
        P('M8 34H50C54 34 56 31 56 27'),
        P('M8 44H34C38 44 42 47 42 52C42 56 38 57 35 54'),
    ),
    'eye': svg(
    ...
    'map': svg(
        P('M12 18L24 14L40 18L52 14V46L40 50L24 46L12 50V18Z'), P('M24 14V46'), P('M40 18V50')
    ),
    'snake': svg(
        P('M14 20C14 20 26 20 26 28C26 36 14 36 14 44C14 50 22 52 28 50'),
        P('M26 28C26 20 38 20 38 28C38 36 50 36 50 44C50 50 44 52 40 50'),
        C(16, 18, 2.5, 0, 'fill="currentColor"'),
    ),
    'fire': svg(
        P(
            'M32 8C32 8 20 20 20 36C20 45 25 52 32 52C39 52 44 45 44 36C44 30 40 26 40 26C40 30 37 32 35 32C35 24 32 8 32 8Z'
        ),
        P('M30 44C30 40 32 38 34 38'),
    ),
    'spy': svg(
        P('M14 30C14 30 20 18 32 18C44 18 50 30 50 30'),
        P('M10 32H54'),
        C(22, 40, 7),
        C(42, 40, 7),
        P('M29 40H35'),
    ...
    'hourglass': svg(
        P('M16 10H48'),
        P('M16 54H48'),
        P('M18 10C18 24 32 28 32 32C32 36 18 40 18 54'),
        P('M46 10C46 24 32 28 32 32C32 36 46 40 46 54'),
    ),
    'sword': svg(
        P('M48 12L28 32L32 36L52 16V12H48Z'),
        P('M14 44L24 34', 2.5),
        P('M12 52L20 44'),
        P('M16 40L24 48', 2.5),
    ),
    'castle': svg(
        P('M12 26V52H52V26L46 26V20H40V26H36V20H28V26H24V20H18V26H12Z'), P('M26 52V40H38V52')
    ),
    'lock': svg(
    ...
    'split': svg(
        P('M32 12V28'),
        P('M32 28C32 28 32 38 20 42'),
        P('M32 28C32 28 32 38 44 42'),
        P('M16 48L20 42L26 46', 2.5),
        P('M38 46L44 42L48 48', 2.5),
    ),
}
...
if __name__ == '__main__':
    ...
    for i, slug in enumerate(ORDER):
        ...
        out = OUT / (slug + '.html')
        out.write_text(
            page(CHAPTERS[slug], prev_href, prev_label, next_href, next_label), encoding='utf-8'
        )
